...
//    public String registerParticipant(@RequestBody Map<String, String> userInfo){
//        DateCondition activeTime;
//        try {
//            activeTime = new DateCondition(new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").parse(userInfo.get("activeTime")).getTime());
